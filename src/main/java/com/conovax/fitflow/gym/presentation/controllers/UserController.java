package com.conovax.fitflow.gym.presentation.controllers;

import com.conovax.fitflow.gym.application.dto.request.UserGymsByEmailRequest;
import com.conovax.fitflow.gym.application.dto.request.UserRegisterWithGymsRequest;
import com.conovax.fitflow.gym.application.dto.request.GymUserRelationRequest;
import com.conovax.fitflow.shared.application.dto.request.ChangePasswordRequest;
import com.conovax.fitflow.shared.application.dto.request.UpdateProfileRequest;
import com.conovax.fitflow.shared.application.pagination.PageResponse;
import com.conovax.fitflow.shared.application.dto.response.ErrorResponse;
import com.conovax.fitflow.shared.application.dto.response.LoginGymsResponse;
import com.conovax.fitflow.shared.application.dto.response.PeopleResponse;
import com.conovax.fitflow.gym.application.dto.response.UserGymUserResponse;
import com.conovax.fitflow.gym.application.dto.response.UserResponse;
import com.conovax.fitflow.gym.application.services.UserGymUsersService;
import com.conovax.fitflow.gym.application.services.GymUserRegisterService;
import com.conovax.fitflow.gym.application.services.UserRegisterWithGymsService;
import com.conovax.fitflow.gym.application.services.UserService;
import com.conovax.fitflow.shared.infrastructure.security.annotations.RequireActiveGymSubscription;
import com.conovax.fitflow.shared.infrastructure.security.annotations.RequirePermission;
